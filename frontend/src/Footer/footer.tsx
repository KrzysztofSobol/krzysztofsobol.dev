            ...
            <div className="footer">
                ...
                <p className="footer-right">
                    <svg onClick={openGithub} className={"icon-svg"} width="56px" height="56px" viewBox="0 0 24 24"
                         xmlns="http://www.w3.org/2000/svg" fill="#f4f8ff"
                    ...
                    <svg onClick={openLinkedin} className={"icon-svg"} fill="#f4f8ff" width="53px" height="53px" viewBox="0 0 32 32" version="1.1"
