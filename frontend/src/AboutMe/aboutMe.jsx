            ...
            <div className={"aboutMe-tile"}>
                <div className={"Tile"}>
                    <h1 className={"aboutMeTitle"}>
                        ...
                        <header className={"headerTextAboutMe"}>About me</header>
                    </h1>
                    <h2 className={"AboutMeContent"}>
                        <p>I'm <span className="highlight">Krzysztof Sobolewski</span>, a young <span
                            ...
                            Along the way, I've also experienced other languages like <span
                                className="highlight">C</span>, <span
                            ...
                            I particularly love <span className="highlight">solving algorithmic</span> problems, data
                            structures
