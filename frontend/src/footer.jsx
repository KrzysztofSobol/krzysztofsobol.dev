    ...
    return (
        <div className="footer-container">
            <div className="footer">
                <p className="left">krzysztofsobol.xyz</p>
                <p className="right">
                    <svg className={"github-svg"} width="56px" height="56px" viewBox="0 0 24 24"
                    ...
                    <svg fill="#FFFFFF" width="53px" height="53px" viewBox="0 0 32 32" version="1.1"
